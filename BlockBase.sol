...
contract ExpenseTracker {
    ...
    /**
    * @dev Get the label of the most recent expense
    * @return label The description of the most recent expense
    */
    function getLastExpenseLabel() public view returns (string memory) {
       require(expenseCount > 0, "No expenses found");

        uint256 lastExpenseId = expenseCount - 1;  // The last expense is at index expenseCount - 1
        return expenses[lastExpenseId].label;  // Fetch the label of the last expense
    }
